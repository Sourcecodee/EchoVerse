...
const About = () => {
  return (
    <div className="overflow-auto h-screen w-full bg-black container mx-auto md:px-14 py-7 flex flex-col">
        ...
        <div style={{fontFamily: 'Playwrite ES'}} className='text-2xl md:text-5xl text-white w-full flex justify-center mt-10'>About</div>
