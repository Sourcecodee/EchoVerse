...
const Songs = () => {
  ...
  return (
    <div className="overflow-auto h-screen w-full bg-gradient-to-br from-red-500 to-blue-700 container mx-auto md:px-14 py-7 flex flex-col">
        ...
        <div style={{fontFamily: 'Playwrite ES'}} className='text-5xl text-white w-full flex justify-center mt-10'>Songs</div>

        {/* container for blog cards */}
        <div className='mt-10 flex gap-1 items-center'>

            <button className='border bg-slate-600 p-3 rounded-sm' onClick={getSongs}>GetSong</button>
