...
const NavBar = () => {
  ...
  useEffect(() => {
    ...
    tl.to(boxRef.current, { x: 0, duration: 2, opacity: 0.5, zoom: 5 }).to(
      boxRef.current,
      { x: 0, duration: 2, opacity: 1, zoom: 1 }
    );
  }, []);
  ...
  return (
    ...
    >
      ...
      <div className='flex flex-row justify-center items-center'>
        ...
        <div
          onClick={setValue}
          className='flex flex-col justify-center py-1 items-center hover: cursor-pointer h-8 gap-1'
        >
