...
const Card = () => {
  ...
  useEffect(() => {
    gsap.to(musicRef.current, { x: 0, duration: 2, opacity: 1, width: '230px' });
  }, []);

  return (
    <div ref={musicRef} className='opacity-0 w-0 p-3 hidden sm:block border border-slate-700 text-white rounded-md relative left-4 top-6'>
      {/* music image */}
